  ...
  return (
    <aside className={styles.sidebar}>
      ...
      <nav className={styles.sidebarNav}>
        <Link 
          to="/home/perfil" 
          className={`${styles.navLink} ${location.pathname === '/home/perfil' ? styles.navLinkActive : ''}`}
        >
        ...
        <Link 
          to="/home/projetos" 
          className={`${styles.navLink} ${location.pathname === '/home/projetos' ? styles.navLinkActive : ''}`}
        >
